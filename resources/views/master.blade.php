                ...
                <div class="row align-items-center">
                    <div class="col-4">
                        <div class="header-right-socail d-flex align-items-center">
                            <h6 class="font-la color-white fw-normal">Chào mừng đến với Trường Kinh Doanh và Lãnh Đạo</h6>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6">
                    <div class="banner-home__content pb-lg-60 pb-md-50 pb-sm-45 pb-xs-40 wow fadeInLeft"
                        ...
                        <h1 class="title color-white fw-bold mb-20 mb-sm-15 mb-xs-10">Build Up Your Business Strategy
                        </h1>
                    ...
                    <div class="col-lg-6">
                        <div class="our-company__content mt-md-50 mt-sm-40 mt-xs-35 wow fadeInUp"
                            ...
                            <span class="sub-title fw-500 color-red text-uppercase mb-sm-10 mb-xs-5 mb-20 d-block"><img
                                    src="assets/img/home/line.svg" class="img-fluid mr-10" alt=""> Know Our
                                Company</span>
                            <h2 class="title color-pd_black mb-20 mb-sm-15 mb-xs-10">Our Company Provide High Quality
                                Idea</h2>
            ...
            <div class="row align-items-center">
                <div class="col-sm-9">
                    <div class="planning-success__content mb-xs-35 wow fadeInUp" data-wow-delay=".3s">
                        <h2 class="title mb-20 mb-sm-15 mb-xs-10 color-white">Good Business Planning Ensures Success.
                        </h2>
                        ...
                        <a href="services.html" class="theme-btn btn-sm btn-red">View All Services <i
                                class="far fa-chevron-double-right"></i></a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-7">
                        <div class="can-help__content  mb-sm-40 mb-xs-40 mb-md-45 mb-lg-50 wow fadeInUp"
                            data-wow-delay=".3s">
                            <h2 class="title color-white mb-sm-15 mb-xs-10 mb-20">Experience The Evolution Of Your
                                Business</h2>
...
<!-- Mirrored from html.rrdevs.net/consulter/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Dec 2024 07:23:26 GMT -->
