        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="our-company__content mt-md-50 mt-sm-40 mt-xs-35 wow fadeInUp" data-wow-delay=".3s">
                    <span class="sub-title fw-500 color-primary text-uppercase mb-sm-10 mb-xs-5 mb-20 d-block"><img src="{{ asset('assets/img/team-details/badge-line.svg') }}" class="img-fluid mr-10" alt=""> Know Our Company</span>
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="company-skill__content wow fadeInUp" data-wow-delay=".3s">
                    <span class="sub-title d-block fw-500 color-primary text-uppercase mb-sm-10 mb-xs-5 mb-md-15 mb-20"><img src="{{ asset('assets/img/team-details/badge-line.svg') }}" class="img-fluid mr-10" alt="">Company Skills</span>
        ...
        <div class="row">
            <div class="col-12">
                <div class="our-team__content mb-65 mb-md-50 mb-sm-40 mb-xs-30 text-center wow fadeInUp" data-wow-delay=".3s">
                    <span class="sub-title fw-500 color-primary text-uppercase mb-sm-10 mb-xs-5 mb-15 d-block"><img src="{{ asset('assets/img/team-details/badge-line.svg') }}" class="img-fluid mr-10" alt=""> Our Team</span>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="testimonial__content mb-60 mb-md-50 mb-sm-40 mb-xs-30 text-center wow fadeInUp" data-wow-delay=".3s">
                        <h6 class="sub-title fw-500 color-primary text-uppercase mb-sm-10 mb-xs-5 mb-15"><img src="{{ asset('assets/img/team-details/badge-line.svg') }}" class="img-fluid mr-10" alt=""> Testimonials</h6>
